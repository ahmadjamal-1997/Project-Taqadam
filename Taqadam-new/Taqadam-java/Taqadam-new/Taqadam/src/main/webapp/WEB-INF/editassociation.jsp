...
<title>Edit information for association</title>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #b4bcb2;">
    ...
    <div class="container" >
    		...
    		<div class="col-2"></div>
                	...
                	<p class="fs-3">Edit information for association!<p>
                	</div>
                 </div>
                 <div class="col-3 form">
                
                <form:form method="POST" action="/edit/association/${association.id}" modelAttribute="association">
