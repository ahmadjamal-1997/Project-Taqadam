...
<body style="background-color: wheat;">
    ...
    <div class="container">
        <div class="container-fluid">
            <div class="row w-100 p-3" style="margin: 0 auto;">
                <div id="information" class="col-9 text-white">
                    <div class="row">
                        <div class="col-12 text-break">${user.firstName } ${user.lastName }</div>
                    </div>
                    <div class="row">
                        <div class="col">${user.email } | ${user.field } | ${user.phone } | ${user.university }</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-2">
                        <div class="col">
                            <div class="edit">
                                <a href="/edit/student/${user.id }" style="color:rgb(255, 255, 255)">Edit information</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="container-fluid">
            <div class="row p-3 fs-3">
                <div class="col-9" style="color: #224c3c;">My projects</div>
                <div class="col-3 fs-5" style="color: #224c3c;"><h1 class="fs-4 mx-2">Create</h1> 
                <div class="rounded-circle" style="height:80px;width:80px;background-color:#fddf4e;"><a class="mx-4" style="color:#5a501c;text-decoration:none;font-size:50px;"  href="/createProject">+</a></div>
                </div>
            </div>
        </div>
