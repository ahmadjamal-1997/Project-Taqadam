   ...
   <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #b4bcb2;">
    ...
    <div class="container" >
    		...
    		<div class="col-2"></div>
                	...
                	<p class="fs-3">Edit Your Project Now!<p>
                	</div>
                 </div>
                 <div class="col-3 form">
                    <h3 style="color: white;">Edit Your Project</h3>
                
                <form:form method="POST" action="/editProject/${projects.id }" modelAttribute="projects">
