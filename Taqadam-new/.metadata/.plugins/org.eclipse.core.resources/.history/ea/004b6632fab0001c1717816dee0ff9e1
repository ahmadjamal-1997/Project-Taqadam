    ...
    <div class="container">
        <div class="container-fluid">
            <div class="row w-100 p-3" style="margin: 0 auto;">
                <div id="information" class="col-9 text-white">
                    <div class="row">
                        <div class="col-12 text-break">Company Name : ${user.userName}</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-2">
                        <div class="col">
                            <div class="edit">
                                <a href="/edit/company/${user.id }" style="color:rgb(255, 255, 255)">Edit information</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="container-fluid">
            <div class="row p-3 fs-3">
                <div class="col" style="color: #224c3c;">My projects</div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row p-3">
                ...
                <div class="card container-fluid col-3 mx-2" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="display: flex;justify-content: space-around">
                            <div class="col-6 ">
                                <a href="#" class="btn btn-warning fs-5" style="height: 50px;width: 160px;">Go
                                    somewhere</a>
                            </div>
                            <div
